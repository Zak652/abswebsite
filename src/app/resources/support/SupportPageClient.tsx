    ...
    return (
        <div className="min-h-screen bg-surface pt-24 pb-32">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <Link href="/" className="inline-flex items-center text-sm font-medium text-primary-900/60 hover:text-accent-700 transition-colors mb-12">
                    <ArrowLeft className="w-4 h-4 mr-2" /> Back
                </Link>

                <div className="flex items-center gap-4 mb-12">
                    <div className="p-3 rounded-2xl bg-accent-600/10">
                        <LifeBuoy className="w-6 h-6 text-accent-700" />
                    </div>
                    <div>
                ...
                <div className="grid sm:grid-cols-3 gap-6 mb-12">
                    <a href="mailto:support@absplatform.com" className="bg-white rounded-2xl border border-neutral-100 p-6 hover:border-accent-600 transition-colors group shadow-sm">
                        <Mail className="w-6 h-6 text-accent-700 mb-4" />
                        <p className="font-semibold text-primary-900 mb-1 group-hover:text-accent-700 transition-colors">Email Support</p>
                    ...
                    <a href="mailto:sales@absplatform.com" className="bg-white rounded-2xl border border-neutral-100 p-6 hover:border-accent-600 transition-colors group shadow-sm">
                        <MessageSquare className="w-6 h-6 text-primary-500 mb-4" />
                        <p className="font-semibold text-primary-900 mb-1 group-hover:text-accent-700 transition-colors">Sales Enquiries</p>
                    ...
                    {submitted ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div className="grid sm:grid-cols-2 gap-5">
                                <div>
                                    <label className="text-xs font-medium text-primary-900/60 mb-1.5 block">Full name <span className="text-accent-700">*</span></label>
                                ...
                                <div>
                                    <label className="text-xs font-medium text-primary-900/60 mb-1.5 block">Work email <span className="text-accent-700">*</span></label>
                            ...
                            <div>
                                <label className="text-xs font-medium text-primary-900/60 mb-1.5 block">Message <span className="text-accent-700">*</span></label>
                            ...
                            <button type="submit" disabled={submitting} className="w-full sm:w-auto bg-primary-900 text-white px-8 py-3.5 rounded-xl font-medium hover:bg-accent-600 transition-colors disabled:opacity-60 disabled:cursor-not-allowed">
                ...
                <div className="bg-primary-900 rounded-3xl p-8 text-center">
                    ...
                    <a href="mailto:support@absplatform.com?subject=URGENT: " className="inline-flex items-center gap-2 bg-accent-600 text-white px-6 py-3 rounded-xl font-medium hover:bg-accent-600 transition-colors">Send Urgent Request</a>
                </div>
            </div>
        </div>
    );
